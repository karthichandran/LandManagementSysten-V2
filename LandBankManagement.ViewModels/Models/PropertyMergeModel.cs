...
namespace LandBankManagement.Models
{
    public class PropertyMergeModel : ObservableObject
    {
        ...
        public string MergedSaleValue1 { get; set; }
        public string MergedSaleValue2 { get; set; }
        public string MergedAmountPaid1 { get; set; }
        public string MergedAmountPaid2 { get; set; }
